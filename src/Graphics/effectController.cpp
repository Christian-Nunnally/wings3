...
{
    //return fireworksEffect(frameTimeDelta, effect1Time1, ledIndex, 40, *currentPalette1OffsetPointer, 65535);
    //return lightChaseEffect(effect1Time1, ledIndex, effect1Time2, *currentPalette1OffsetPointer, 5, 65535);
