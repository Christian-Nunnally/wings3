...
flippedYLayout = [
    PhysicalLedIndexMapping[0], PhysicalLedIndexMapping[1], 
    PhysicalLedIndexMapping[22], PhysicalLedIndexMapping[21], 
    PhysicalLedIndexMapping[4], PhysicalLedIndexMapping[5], 
    PhysicalLedIndexMapping[18], PhysicalLedIndexMapping[17], 
    PhysicalLedIndexMapping[8], PhysicalLedIndexMapping[9], 
    PhysicalLedIndexMapping[14], PhysicalLedIndexMapping[13],
    PhysicalLedIndexMapping[12],
    PhysicalLedIndexMapping[11], PhysicalLedIndexMapping[10], 
    PhysicalLedIndexMapping[15], PhysicalLedIndexMapping[16], 
    PhysicalLedIndexMapping[7], PhysicalLedIndexMapping[6], 
    PhysicalLedIndexMapping[19], PhysicalLedIndexMapping[20], 
    PhysicalLedIndexMapping[3], PhysicalLedIndexMapping[2], 
    PhysicalLedIndexMapping[23], PhysicalLedIndexMapping[24],
    ]
